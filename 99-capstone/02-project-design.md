...
> Companion to [01-workshop-spec.md](./01-workshop-spec.md). High-level and low-level design: diagrams, contracts, schemas. **Code organization is yours** — crates, modules, workspace layout are learner decisions.
